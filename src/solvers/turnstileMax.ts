...
import { withCtx, waitForCF, waitForToken, buildProxyUrl, registerPage } from './base'
        ...
        var _interval = setInterval(function() {
          try {
            ...
            if (t && t.length > 10) {
              ...
              if (!el) { el = document.createElement('input'); el.type = 'hidden'; el.name = 'cf-response'; document.body.appendChild(el); }
              el.value = t;
